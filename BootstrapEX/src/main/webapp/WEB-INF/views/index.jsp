        ...
        <nav class="navbar navbar-light navbar-vertical navbar-expand-xl navbar-card">
          ...
          <div class="d-flex align-items-center">
            <div class="toggle-icon-wrapper">
              ...
              <div class="d-flex align-items-center py-3"><img class="me-2" src="assets/img/icons/hotel.png" alt="" width="40" /><span class="font-sans-serif text-primary">HOTEL OZEN</span>
              </div>
            </a>
          </div>
